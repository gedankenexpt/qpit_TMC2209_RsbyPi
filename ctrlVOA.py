...
if __name__ == "__main__":
    ...
    # -----------------------------------------------------------------------
    tmc = TMC_2209(pin_en, pin_step, pin_dir, loglevel=Loglevel.DEBUG, skip_uart_init=True)
    ...
    if steps_to_move:
        ...
        for i in range(4):
            ...
            tmc.run_to_position_steps(2000, MovementAbsRel.RELATIVE)  # move 2400 steps forward
            tmc.run_to_position_steps(-2000, MovementAbsRel.RELATIVE)  # move 2400 steps backward
            print(f'Iteration {i+1} finished, waiting for 2 sec')
            time.sleep(2)
